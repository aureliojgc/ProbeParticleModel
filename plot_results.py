...
for iq,Q in enumerate( Qs ):
    for ik,K in enumerate( Ks ):
        ...
        if  opt_dict['LCPD_maps']:
            ...
            PPPlot.plotImages(
                "./LCPD"+atoms_str+cbar_str, LCPD,  slices = range( 0, len(LCPD) ), zs=zTips+PPU.params['Amplitude']/2.0,
        ...
        if  opt_dict['LCPD_maps']:
            PPPlot.plotImages(
                "./_Asym-LCPD"+atoms_str+cbar_str, LCPD,  slices = range( 0, len(LCPD) ), zs=zTips+PPU.params['Amplitude']/2.0,
