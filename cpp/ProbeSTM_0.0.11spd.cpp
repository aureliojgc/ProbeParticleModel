...
extern "C"{
 ...
 void proc_IETSspsp( int const_orb, int NoAt, int NoOrb, int Npoints, double V, double WF, double eta, double Amp, double* eig, double* R_, double* Rat_, double* coesin, double* tip_coes, double* cur){
 	decay = sqrt( abs(WF+WF)*eV);
	Norm = four_pi*decay;
	Vec3d * R = ( Vec3d * ) R_;
	Vec3d * Ratin = (Vec3d *) Rat_;
