...
class OCLEnvironment:
    ...
    def printInfo(self):
        print ( cl.context_info.DEVICES )
        A = self.ctx.get_info(cl.context_info.DEVICES)
        B = self.ctx.get_info(cl.context_info.PROPERTIES)
        C = self.ctx.get_info(cl.context_info.REFERENCE_COUNT)
        print( "======= DEVICES\n",         str( A ) )
        print( "======= PROPERTIES\n",      str( B ) )
